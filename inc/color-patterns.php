 ...
 */
function pu_hostels_2017_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'pu_hostels_2017_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.pu_hostels_2017-front-page) .entry-title,
...
.colors-custom .pu_hostels_2017-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.pu_hostels_2017-front-page .panel-content .recent-posts article,
...
.colors-custom.pu_hostels_2017-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'pu_hostels_2017_custom_colors_css', $css, $hue, $saturation );
}
