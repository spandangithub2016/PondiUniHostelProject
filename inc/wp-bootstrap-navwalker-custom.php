...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
	...
	class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_lvl( &$output, $depth = 0, $args = array() ) {
            ...
            // data-default-font-size should be changed according to theme.
			$output .= "\n$indent<ul role=\"menu\" class=\" dropdown-menu\" data-default-font-size=\"14\">\n";
		}
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			* a 0 if the strings are equal.
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				 ...
				 * if there is a value in the attr_title property. If the class list
				 * contains a class starting with "ic-*", use * as glyphicon classname
				 */
                 $glyph_class = "";
				...
				if ( ! empty( $glyph_class ) ) :
					...
					if ( false !== $pos ) :
						$item_output .= '<a' . $attributes . '><span class="glyphicon ' . esc_attr( $item->attr_title ) . '" aria-hidden="true"></span>&nbsp;';
									...
									$item_output .= '<a' . $attributes . '><span class="glyphicon glyphicon-' . $glyph_class . '" aria-hidden="true"></span> ';
											endif;
				else :
